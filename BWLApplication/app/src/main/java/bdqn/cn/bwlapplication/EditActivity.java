package bdqn.cn.bwlapplication;
...
import apk.cn.myapk.R;
import bdqn.cn.bwlapplication.database.MyDB;
import bdqn.cn.bwlapplication.util.DataFormatType;
import bdqn.cn.bwlapplication.util.MyFormat;
import bdqn.cn.bwlapplication.util.MyTimeGetter;

import static bdqn.cn.bwlapplication.util.MyFormat.*;
...
public class EditActivity extends BaseActivity implements   View.OnClickListener,
        ...
        void init(){
            ...
            createDate = myDateFormat(date,DataFormatType.NORMAL_TIME);
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            String noticeStr = "  提醒时间："+getTimeStr(
                    myDateFormat(year,(month+1),dayOfMonth,hour,minute,DataFormatType.NORMAL_TIME));
