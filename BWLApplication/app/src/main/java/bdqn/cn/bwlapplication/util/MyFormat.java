package bdqn.cn.bwlapplication.util;
...
public class MyFormat {
    ...
    public static String myDateFormat(Date date, @Nullable DataFormatType dateFormatType){

        SimpleDateFormat dateFormat;
        if (dateFormatType == null){
            dateFormatType = DataFormatType.NORMAL_TIME;
        }
     ...
     */
    @SuppressLint("SimpleDateFormat")
    public static Date myDateFormat(String str,@Nullable DataFormatType dateFormatType){
        SimpleDateFormat dateFormat;
        if (dateFormatType == null){
            dateFormatType = DataFormatType.NORMAL_TIME;
        }
    ...
    public static Date myDateFormat(Integer year,
                                    ...
                                    Integer hour,
                                    Integer minute,
                                    @Nullable DataFormatType dateFormatType){
        SimpleDateFormat dateFormat;
        String str;
        if (dateFormatType == null){
            dateFormatType = DataFormatType.NORMAL_TIME;
    ...
    public static String getTimeStr(Date date){
        ...
        if (nowYear == targetYear){
            //  去除年份
            return myDateFormat(date,DataFormatType.REMOVE_YEAR_TIME);
        }
        return myDateFormat(date,DataFormatType.NORMAL_TIME);
    }
}